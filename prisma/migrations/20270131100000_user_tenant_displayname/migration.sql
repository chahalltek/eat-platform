...
-- Add displayName column and backfill from existing data
...
-- Drop old unique constraint on email if it exists and recreate the expected one
DO $$
DECLARE
...
-- Enforce tenant/email uniqueness and add tenant index
