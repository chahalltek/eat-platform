-- db-safety-ignore-destructive: adjusts constraints to match Prisma schema
-- Re-ensure user table has tenantId and displayName columns for environments that missed earlier hotfixes
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "tenantId" TEXT NOT NULL DEFAULT 'default-tenant';
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "displayName" TEXT;

-- Backfill displayName from existing data if needed
DO $$
DECLARE
    name_exists BOOLEAN;
BEGIN
...
-- Normalize constraints and indexes
DO $$
DECLARE
