...
=======
  async function handleCopyShortlistToClipboard() {
    ...
    try {
      ...
      lines.push('');
      lines.push(
        '_Generated by EAT-TS shortlist (Match + Confidence based)._'
      );
...
=======
        submit based on match and confidence, then export or copy them directly
        into an email or client update.
>>>>>>> theirs
      </p>
    </div>
  );
