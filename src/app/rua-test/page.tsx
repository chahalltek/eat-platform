...
export default function RuaTestPage() {
      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-6 rounded-2xl bg-white p-8 shadow-sm ring-1 ring-zinc-200">
        <header className="space-y-2">
          ...
          <p className="text-sm text-zinc-600">
            Paste a job description below and send it through the RUA agent. The response
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="text-xs text-zinc-500">
              Payload: &#123; recruiterId: &quot;charlie&quot;, rawJobText &#125;
            </p>
          </div>
        </form>
        ...
        {result && (
          <section className="space-y-2 text-sm">
            ...
            <p className="text-zinc-600">
              Use <code>jobReqId</code> to find the record and <code>agentRunId</code>
              for the agent log.
            </p>
          </section>
        )}
