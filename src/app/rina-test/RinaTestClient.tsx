...
export function RinaTestClient({ agentsEnabled }: RinaTestClientProps) {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (!agentsEnabled) {
      setError("Agents are disabled right now. Enable the Agents flag to run RINA.");
      return;
    }
  ...
  return (
    <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-zinc-200">
      <div className="space-y-2">
        <p className="text-xs font-semibold uppercase tracking-wide text-indigo-600">ETE-001</p>
